package cn.muse.lib_gif.decoder;
...
import cn.muse.lib_gif.encoder.GifEncoder;
import cn.muse.lib_gif.encoder.NeuQuant;

/**
 * @author: wanshi
 * created on: 2019-09-11 16:52
 * description:
 */
public class AnimatedGifEncoder {
    ...
    protected void writePixels() throws IOException {
        GifEncoder encoder = new GifEncoder(width, height, indexedPixels, colorDepth);
        encoder.encode(out);
    }
